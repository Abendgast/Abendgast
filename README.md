                            ...
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        ...
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="241.07666666666665 155"/>
                                    </svg>
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    <div class="value-wrapper">
                                        <div class="value">3333</div>
                                    </div>
                                </div>
                                <div class="text">Repositories have been deployed 3333 times</div>
                            </div>
                        </div>
                        <div class="achievement s largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="41.02333333333333 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    stargazer
                                    <div class="value-wrapper">
                                        <div class="value">1397</div>
                                    </div>
                                </div>
                                <div class="text">Starred 1397 repositories</div>
                            </div>
                        </div>
                        <div class="achievement s largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="15.902999999999999 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                <div class="title">
                                    <span class="prefix">Master</span>
                                    maintainer
                                    <span class="gh">ranked 2.69k out of 169m repositories</span>
                                    <div class="value-wrapper">
                                        <div class="value">11539</div>
                                    </div>
                                </div>
                                <div class="text">Maintaining a repository with 11539 stars</div>
                            </div>
                        </div>
                        <div class="achievement s largeable-width-half">
                            <div class="icon">
                        ...
                        <div class="achievement a largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="63.018480492813126 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                        ...
                        <div class="achievement b largeable-width-half">
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    developer
                                    <span class="gh">ranked 1.06m out of 125m users</span>
                                    <div class="value-wrapper">
