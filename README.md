...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  <div style="display: flex; flex-direction: row; margin-bottom: 20px;">
    <a href="https://github.com/Abendgast/ProxyObserver" title="ProxyObserver" style="margin-right: 20px; flex-grow: 1;">
    ...
    <a href="https://github.com/Abendgast/Mini-gamePY" title="Mini gamePY" style="flex-grow: 1;">
  ...
  <div style="display: flex; flex-direction: row; margin-bottom: 20px;">
    <a href="https://github.com/Abendgast/Price-Determinator-BTC-USDT" title="Price Determinator BTC USDT" style="margin-right: 20px; flex-grow: 1;">
    ...
    <a href="https://github.com/Abendgast/2023-C-Backup" title="2023 C Backup" style="flex-grow: 1;">
