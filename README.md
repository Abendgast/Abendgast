...
>> [ЗЛовмисне ]]недоКінчене посилання(

>>> ![Невірний альтернативний текст]Зображення без посилання)

>>>> ```
>>>>> Незакритий код
>>>>>> ```

>>>>>>> # Заголовок з \недійсними /символами

>>>>>>>> | Таблиця | Без | Вирівнювання |
>>>>>>>>> | --- | ---: | :--- |
>>>>>>>>>> | Дані | Недійсне | Вирівнювання |

>>>>>>>>>>> **Жирний **Незакритий **текст

>>>>>>>>>>>> _Курсивний _Незакритий _текст

>>>>>>>>>>>>> ~~Перекреслений ~~Незакритий ~~текст
